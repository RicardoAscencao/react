export default function Product(props) {
  ...
  const handleVote = (event) => {
    ...
    let upVote = event.target.classList.contains('up');
    console.log(upVote);
    ...
    <section className="item">
      ...
      <article className="middle aligned content">
        <div className="header">
            <a onClick={handleVote} ><i className="large caret up icon"></i></a>
            {votes}
            <a onClick={handleVote} ><i className="large caret down icon"></i></a>
        </div>
